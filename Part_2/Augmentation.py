...
def distort_image(img):
    ...
    return distorted_img.transform((new_width, new_height),
                                   Image.PERSPECTIVE,
...
def shear_image(img):
    ...
    coeffs = (1, shear_factor, 0,
              0, 1, 0)
    return sheared_img.transform((new_width, new_height),
                                 Image.AFFINE,
                                 coeffs,
                                 Image.BICUBIC)
...
def skew_image(img):
    ...
    coeffs = (1, skew_factor, 0,
              0, 1, 0)
    return skewed_img.transform((new_width, new_height),
                                Image.AFFINE,
                                coeffs,
                                Image.BICUBIC)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 2:
        ...
        elif sys.argv[1][-4:].lower() not in type and \
